...
import com.oneplus.extras.speaker.ClearSpeakerActivity;
import com.oneplus.extras.preferences.CustomSeekBarPreference;
import com.oneplus.extras.R;
import com.oneplus.extras.SuShell;
import com.oneplus.extras.SuTask;
import com.oneplus.extras.thermal.ThermalActivity;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.oneplus.extras.FPSInfoService.class);
            if (enabled) {
